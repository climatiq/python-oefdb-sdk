...
def test_check_ids_for_unsupported_characters():
    ...
    oefdb_df_without_invalid_characters_in_the_id_column = load_oefdb_fixture_dataframe(
    ...
    oefdb_df_with_invalid_characters_in_the_id_column = load_oefdb_fixture_dataframe(
