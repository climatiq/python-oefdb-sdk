...
def test_check_oefdb_structure():
    ...
    oefdb_df_with_a_valid_structure = load_oefdb_fixture_dataframe(
    ...
    oefdb_df_with_a_column_missing = load_oefdb_fixture_dataframe(
    ...
    oefdb_df_with_an_extra_column = load_oefdb_fixture_dataframe(
    ...
    oefdb_df_with_a_misnamed_column = load_oefdb_fixture_dataframe(
