...
def test_check_for_duplicates():
    ...
    oefdb_df_without_duplicates = load_oefdb_fixture_dataframe(
    ...
    oefdb_df_with_a_duplicate_row = load_oefdb_fixture_dataframe(
    ...
    oefdb_df_with_a_compound_key_is_duplicate = load_oefdb_fixture_dataframe(
    ...
    oefdb_df_with_a_compound_key_is_not_duplicate = load_oefdb_fixture_dataframe(
